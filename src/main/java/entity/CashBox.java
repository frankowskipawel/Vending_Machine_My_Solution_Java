...
public class CashBox {
    ...
    public List<Coin> spendTheRest(double a) {
        ...
        if (amount == 0) {
            cashInStock.removeAll(coinList);
            return coinList;
        } else {
            return null;
        }
    ...
    public Double getAmountInTempCoinBox() {
        Double amount = 0d;
